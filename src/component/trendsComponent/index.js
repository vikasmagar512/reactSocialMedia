...
export class RepositoryComponent extends Component {
  ...
  getRepositoryList(result) {
    ...
    // const userRepoApi = `https://api.twitter.com/1.1/search/tweets.json?q=%23freebandnames&since_id=24012619984051000&max_id=250126199840518145&result_type=mixed&count=4`;
    fetch(userRepoApi)
      .then(response => {
          if (!response.ok) {
